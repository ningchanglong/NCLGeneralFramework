...
//static void * const xwAdd_mchID_key = "1389934402";
//static void * const xwAdd_appID_key = "wxe6effc63c67bff3b";
//static void * const xwAdd_secretKey_key = "30500f99bbac21abc74a30db6d69e648";
//static void * const xwAdd_partnerKey_key = "RQNBG8W7fcXgKVspwbY39W8jkONfTxks";
...
+ (void)xwAdd_sendPayRequestWithOrderID:(NSString *)orderID
    ...
    NSString *mchID = MCH_ID;
    NSString *secretKey = WX_APPSecret;
    ...
    //生成预支付信息字典
    NSDictionary *prePayDict = @{@"appid" : WX_APPID,
                                 @"mch_id" : mchID,
                                 @"nonce_str" : noncestr,
    ...
    BOOL flag = [self wx_PayReqWithAppID:signParams[@"appid"] partnerId:signParams[@"partnerid"] prepayId:signParams[@"prepayid"] nonceStr:signParams[@"noncestr"] timeStamp:signParams[@"timestamp"] package:signParams[@"package"] sign:sign];
                      ...
                      callbackConfig:(void (^)(BOOL successed))config
{
    ...
    NSDictionary *signParams = @{@"appid" : appID,
                                 ...
                                 @"prepayid" : prepayId};
    NSLog(@"********%@",signParams);
    NSLog(@"%@======%u",time,(unsigned int)timeStamp);
    NSString *sign  = [self _xw_createMd5Sign:signParams];
...
+ (BOOL)wx_PayReqWithAppID:(NSString *)appID partnerId:(NSString *)partnerId prepayId:(NSString *)prepayId nonceStr:(NSString *)nonceStr timeStamp:(NSString *)timeStamp package:(NSString *)package sign:(NSString *)sign
{
    //构建请求对象
    PayReq *req = [PayReq new];
